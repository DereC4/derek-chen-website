...
Allows communities to stay open while preventing griefing and protecting builds.`,
    ...
    },
    {
        ...
        description: `Trove is a virtual lost and found database that tackles a real college problem: lost items. Inspired by the $70+ cost of replacing dorm keys, built a cross-platform mobile app enabling students to report lost items and search through a network of found items stored at campus lost-and-found locations. Collaborated with three teammates in 24 hours for HackTX 2022, designing the app in Figma and developing a React Native frontend while the backend team integrated a Java Spring Boot API with MongoDB. Despite being new to React Native and working under tight time constraints, the team delivered a fully functional, aesthetically polished app that won Best Overall Beginner Hack Award out of 75 teams. Demo: https://www.youtube.com/watch?v=Zl_hXwML1_o`,
