...
export const projects: PersonalProject[] = [
    ...
    },
    {
        ...
        description: `Trove is a virtual service platform that allows college students to report lost items and claim valuables through a student network. Built with three teammates in 24 hours for HackTX 2022, where we won Best Overall Beginner Hack Award out of 75 teams. Demo: https://www.youtube.com/watch?v=Zl_hXwML1_o`,
        image: '/images/projects/trove.png',
        technologies: ['React', 'JavaScript', 'HTML/CSS', 'Java', 'MongoDB', 'Spring Boot', 'Figma'],
